 ...
 * Compile with: gcc -o Open OpenLuck.c -lcrypto
...
void usage(char* argv0)
{
	...
	printf("\nGood Luck to all guys who like use lamah ddos. Read SRC to have no surprise\n");
...
int main(int argc, char* argv[])
{
	...
	printf("\n");
	printf("*******************************************************************\n");
	printf("* OpenLuck v3.0.32-root priv8 by SPABAM based on openssl-too-open *\n");
	printf("*******************************************************************\n");
